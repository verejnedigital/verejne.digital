...
def IsGoodCandidate(obst, candidate):
    ...
    if (obst.draft_price > 0):
        ...
        if (lat_lng1 is not None) and (lat_lng2 is not None):
            ...
            if (1000 * dst > obst.draft_price): return False
    return True
