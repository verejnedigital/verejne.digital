...
def read_entities_mock():
    entity_names = ["Jan Novak", "Jana Novakova", "Peter Novak", "Fei Wu", "Li Weng", "Bc. Jan Novak, PhD."]
    ids = [22, 41, 77, 13, 14, 24]
    lats = [0.15, 0.18, 0.18, 0.20, 0.20, 0.15]
    lngs = [0.22, 0.19, 0.19, 0.21, 0.21, 0.22]
