...
const TableLine = ({politician}) => (
  <tr className="table-line">
    ...
    <td className="text-left"><NavLink to={`/profil/${politician.id}`}>{politician.firstname} {politician.surname}</NavLink></td>
    <td className="text-left party-column">{politician.term_start} - {politician.term_finish}</td>
